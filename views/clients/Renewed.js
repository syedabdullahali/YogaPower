...
const Renewed = () => {
    ...
    const saveProspect = () => {
        ...
        let data = {
            ...
            Name: Name, Contact: Contact, Email: email, ServiceName: ServiceName1, AppointmentDate: appointmentDate, AppointmentTime: appointmentTime, CallStatus: CallStatus1, FollowupDate: FollowupDate, TimeFollowp: TimeFollowp, enquiryStage: enquiryStage, Counseller: Counseller, Discussion: Discussion,
        }
